...
class _adminPageState extends State<adminPage> {
  ...
  @override
  void initState() {
    _newsModel = API_Manager().getSchedule();
    super.initState();
  }
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Text("Find Buses", style: TextStyle(fontSize: 14.0),),
                    ],
                  ),
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              Text("Maintain Schedule", style: TextStyle(fontSize: 16.0, color: Colors.white))
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              Text("Maintain Students", style: TextStyle(fontSize: 16.0, color: Colors.white))
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                ...
                                Text("View Schedule", style: TextStyle(fontSize: 16.0, color: Colors.white))
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                ...
                                Text("Messages", style: TextStyle(fontSize: 16.0, color: Colors.white))
